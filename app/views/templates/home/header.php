...
<head>
  ...
  <!-- Font Awesome 5 -->
  <link rel="stylesheet" href="<?= $this->base_url(); ?>/assets/libs/@fontawesome/fontawesome-pro/css/all.min.css">
  <!-- Page CSS -->
  <link rel="stylesheet" href="<?= $this->base_url(); ?>/assets/libs/swiper/dist/css/swiper.min.css">
  <!-- Purpose CSS -->
  <link rel="stylesheet" href="<?= $this->base_url(); ?>/assets/css/purpose.css">
