	...
	<div class="container-fluid">
		...
		<div class="py-5 my-5">
			<div class="text-center">
				<img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="<?= $this->base_url() ?>/assets/img/svg/illustrations/order-confirmed.svg" alt="">
				<span class="clearfix" contextmenu="<?= $data['post'] ?>"></span>
				<p class="lead text-gray-800 mb-2">Congratulations</p>
