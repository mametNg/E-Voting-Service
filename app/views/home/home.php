                  ...
                  <div class="card card-overlay card-hover-overlay shadow text-white border-0">
                    ...
                    <div class="card-img-overlay d-flex flex-column align-items-center p-0">
                      ...
                      <div class="overlay-actions w-100 card-footer mt-auto">
                        <div class="text-center">
                          <?php $usedFruits = []; ?>
                          <?php foreach ($candidate AS $key => $line ) : ?>
                            <?php if (!in_array($line['code'], $usedFruits)) : ?>
                              <?php
                              $usedFruits[] = $line['code']; 
                              $newArray[$key] = $line;
                              ?>
                              <a href="#" class="h6 mb-0" id="open-modal-vote" data-candidate="<?= $this->e($newArray[$key]['code']) ?>" data-key="<?= $this->e($candidateKeys); ?>" data-toggle="modal" data-target="#modal-vote-candidate">Vote as candidate</a>
                            <?php endif; ?>
                          <?php endforeach; ?>
                        </div>
                      </div>
